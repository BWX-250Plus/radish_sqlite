...
public class ActivityBindDevices extends AppCompatActivity {
    ...
    EditText editTextSSID,editTextPassward,editTextName;
    Button buttonAdd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextSSID = findViewById(R.id.bindDevices_tv_wifiName);//WI-Fi名称
        editTextPassward = findViewById(R.id.bindDevices_tv_password);//密码
        editTextName = findViewById (R.id.tv_equipment);

        buttonAdd = findViewById(R.id.bindDevices_btn_search);//按钮
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {//按钮点击
            ...
            public void onClick(View v) {
                /* 隐藏输入法键盘 */
                InputMethodManager inputMethodManager = (InputMethodManager) ActivityBindDevices.this.getSystemService(Context.INPUT_METHOD_SERVICE);
                inputMethodManager.hideSoftInputFromWindow(editTextPassward.getWindowToken(),0);
                ...
                if (buttonAdd.getTag().equals("OK"))
                {
                    ...
                    mTask = new EsptouchAsyncTask4(ActivityBindDevices.this, editTextName.getText ().toString ().trim ());
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], IEsptouchResult, List<IEsptouchResult>> {
        ...
        EsptouchAsyncTask4(ActivityBindDevices activity, String equipmentName) {
